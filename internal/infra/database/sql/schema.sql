...
ALTER TABLE "store_restaurant_type" ADD FOREIGN KEY ("store_id") REFERENCES "store" ("id");

ALTER TABLE "store_restaurant_type" ADD FOREIGN KEY ("restaurant_type_id") REFERENCES "restaurant_type" ("id");
...
ALTER TABLE "store_payment_method" ADD FOREIGN KEY ("payment_form_id") REFERENCES "payment_method" ("id");
