...
type StoreRepository interface {
	...
	FindByFilter(ctx context.Context, params entity.StoreFilter) (*[]entity.Store, error)
	Delete(ctx context.Context, id string) error
	Enable(ctx context.Context, id string) error
	IsOwner(ctx context.Context, id, userID string) (bool, error)
	AddBusinessHour(ctx context.Context, storeID string, params []entity.BusinessHours) error
