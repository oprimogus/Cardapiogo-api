...
CREATE TABLE "restaurants_cousine_types" (
...
ALTER TABLE "restaurants_cousine_types" ADD FOREIGN KEY ("restaurant_id") REFERENCES "restaurant" ("id");

ALTER TABLE "restaurants_cousine_types" ADD FOREIGN KEY ("cousine_type_id") REFERENCES "cousine_type" ("id");
...
ALTER TABLE "restaurants_payment_methods" ADD FOREIGN KEY ("paymentMethod_id") REFERENCES "payment_method" ("id");

ALTER TABLE "restaurants_payment_methods" ADD FOREIGN KEY ("restaurant_id") REFERENCES "restaurant" ("id");

ALTER TABLE "profile_restaurants" ADD FOREIGN KEY ("users_id") REFERENCES "users" ("id");

ALTER TABLE "profile_restaurants" ADD FOREIGN KEY ("restaurant_id") REFERENCES "restaurant" ("id");